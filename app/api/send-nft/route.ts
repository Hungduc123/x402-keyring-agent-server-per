...
// The paid business logic for an NFT (ERC-721/1155) transfer. Only runs after a
// valid x402 payment is verified by the facilitator, so reaching this line means
...
// lib/x402.ts), keyed by "GET /api/send-nft" — this wrapper looks the request up
